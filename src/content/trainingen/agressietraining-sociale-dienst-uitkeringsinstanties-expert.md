---
titel: Expert agressietraining voor leidinggevenden bij de sociale dienst en uitkeringsinstanties
slug: agressietraining-sociale-dienst-uitkeringsinstanties-expert
...
resultaat:
  ...
  - Helder beleid opzetten rond toegangsweigering en aangifte
  - De balans vinden tussen veiligheid en zorgplicht
  - De meldcultuur versterken
programma:
  - titel: Patronen op teamniveau
    inhoud: Analyseren wat er in het team gebeurt en welke patronen onder de meldingen zitten.
  - titel: "Protocol, toegangsweigering en aangifte"
    inhoud: Beleid opzetten dat duidelijk maakt wanneer toegang wordt geweigerd of aangifte wordt gedaan.
  - titel: Veiligheid én zorgplicht
...
- Inconsistente reacties op agressieve cliënten
- Nazorg na ernstige incidenten ontbreekt
- Het beleid rond huisbezoeken is onduidelijk
