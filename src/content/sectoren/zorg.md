...
slug: zorg
samenvatting: >-
  Bureau Weerbaar en Veilig traint zorgmedewerkers in het omgaan met
  agressie die voortkomt uit ziekte, angst en verlies van controle: én
  met agressie van familieleden. Voor acht beroepsgroepen in de zorg, elk
  in drie niveaus.
veelgestelde_vragen:
  - vraag: "Kunnen medewerkers uit verschillende zorgberoepen in één groep?"
    antwoord: "Dat kan, maar het is zelden de beste keuze. De trainingen zijn per beroepsgroep opgebouwd omdat een wijkverpleegkundige, een ambulancemedewerker en een begeleider op een woongroep met andere situaties te maken hebben."
